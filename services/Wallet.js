  ...
  function () {
    ...
    .service('Wallet', function ($http, $q, $rootScope, $uibModal, ABI, Connection, Web3Service) {
      ...
      **/
      ...
      // EIP-1559 fix
      // wallet.getBlock = function (cb) {
      //   return Web3Service.web3.eth.getBlock(
      //     "latest",
      //     function (e, block) {
      //       if (e) {
      //         cb(e);
      ...
      wallet.submitTransaction = function (address, tx, abi, method, params, options, cb) {
        ...
        wallet.getTransactionCount(address, true, true, function (e, count) {
          if (e) {
            ...
            // TODO EIP-1559 fix
            // wallet.getBlock(function (e, block) {
              // if (e) {
              //   cb(e);
              // }
              // var maxPriorityFeePerGas = 1e18; // 1 GWEI
              // var maxFeePerGas = Number(block.baseFeePerGas) + maxPriorityFeePerGas;
